...
public class FactoryService {
	...
	private static final Map<String, Supplier<Quest>> questFactories = Map.ofEntries(
			...
			new AbstractMap.SimpleEntry<String, Supplier<Quest>>(QuestFactory.PART_FINDER_I_QUEST_NAME, QuestFactory::createPartFinderIQuest),
			new AbstractMap.SimpleEntry<String, Supplier<Quest>>(QuestFactory.SPACE_DEBRIS_QUEST_NAME, QuestFactory::createSpaceDebrisQuest),
