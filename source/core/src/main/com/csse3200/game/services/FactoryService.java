...
public class FactoryService {
    ...
    private static final Map<String, Supplier<Entity>> itemFactories = Map.ofEntries(
            ...
            new AbstractMap.SimpleEntry<String, Supplier<Entity>>("Cosmic Cob drop", ItemFactory::createCosmicCobDrop),
            new AbstractMap.SimpleEntry<String, Supplier<Entity>>("Hammer Plant drop", ItemFactory::createHammerPlantDrop),
            new AbstractMap.SimpleEntry<String, Supplier<Entity>>("Deadly Nightshade drop", ItemFactory::createDeadlyNightshadeDrop),
