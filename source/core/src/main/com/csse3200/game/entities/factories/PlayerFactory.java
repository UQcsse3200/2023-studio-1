...
public class PlayerFactory {
  ...
  public static void setupPlayerAnimator(AnimationRenderComponent animator) {
    ...
    animator.addAnimation("idle_down_blink", 0.5f, Animation.PlayMode.NORMAL);
    animator.addAnimation("idle_down_yawn", 0.5f, Animation.PlayMode.NORMAL);
    animator.addAnimation("idle_down_sleep", 0.5f, Animation.PlayMode.NORMAL);
    animator.addAnimation("idle_left_blink", 0.5f, Animation.PlayMode.NORMAL);
    animator.addAnimation("idle_left_yawn", 0.5f, Animation.PlayMode.NORMAL);
    animator.addAnimation("idle_left_sleep", 0.5f, Animation.PlayMode.NORMAL);
    animator.addAnimation("idle_up_blink", 0.5f, Animation.PlayMode.NORMAL);
    animator.addAnimation("idle_up_yawn", 0.5f, Animation.PlayMode.NORMAL);
    animator.addAnimation("idle_up_sleep", 0.5f, Animation.PlayMode.NORMAL);
    animator.addAnimation("idle_right_blink", 0.5f, Animation.PlayMode.NORMAL);
    animator.addAnimation("idle_right_yawn", 0.5f, Animation.PlayMode.NORMAL);
    animator.addAnimation("idle_right_sleep", 0.5f, Animation.PlayMode.NORMAL);
