...
public class NPCFactory {
        ...
        public static Entity createChicken(Entity player) {
                ...
                AnimationRenderComponent animator = new AnimationRenderComponent(
                                ServiceLocator.getResourceService().getAsset("images/animals/chicken.atlas",
                                                TextureAtlas.class),
                                16f);
        ...
        public static Entity createCow(Entity player) {
                ...
                AnimationRenderComponent animator = new AnimationRenderComponent(
                                ServiceLocator.getResourceService().getAsset("images/animals/cow.atlas",
                                                TextureAtlas.class),
                                16f);
        ...
        public static Entity createAstrolotl(Entity player) {
                ...
                AnimationRenderComponent animator = new AnimationRenderComponent(
                                ServiceLocator.getResourceService().getAsset("images/animals/astrolotl.atlas",
                                                TextureAtlas.class),
                                20f);
        ...
        /**
         * Creates a generic animal to be used as a base entity by more specific animal
         * creation methods.
         *
         * @return entity
         */
