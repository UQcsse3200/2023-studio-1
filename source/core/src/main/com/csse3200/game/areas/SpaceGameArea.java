...
public class SpaceGameArea extends GameArea {
  ...
  private Entity spawnCrop() {
    ...
    Entity plant = FactoryService.getPlantFactories().get("Cosmic Cob")
        .apply(newPlayer.getComponent(CropTileComponent.class));
  ...
  private Entity spawnQuestgiver() {
    Entity newQuestgiver = QuestgiverFactory.createQuestgiver(player);
    spawnEntityAt(newQuestgiver, QUESTGIVER_SPAWN, true, true);
    System.out.println(newQuestgiver.getPosition());
    return newQuestgiver;
  }
